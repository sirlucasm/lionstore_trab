...
<body>
    <div class="container">
        ...
        <form action="{{route('user.create')}}" method="post">
            ...
            <div class="row">
                <h4>Termos e condição</h4>
                <div class="input-group">
                    <input id="terms" type="checkbox" required />
                    <label for="terms">Aceito os termos e condições de adesão a este serviço, e por este meio confirmo que li a política de privacidade.</label>
                </div>
            </div>
            <div class="row">
                <div>
